...
class CondensePlusOriginalChatEngine(BaseChatEngine):
    """
    Condense Plus Original Chat Engine.
    ...
    def from_defaults(
        ...
        **kwargs: Any,
    ) -> "CondensePlusOriginalChatEngine":
        """Initialize a CondensePlusOriginalChatEngine from default parameters."""
        ...
        if system_prompt is not None:
            raise NotImplementedError(
                "system_prompt is not supported for CondensePlusOriginalChatEngine."
            )
        if prefix_messages is not None:
            raise NotImplementedError(
                "prefix_messages is not supported for CondensePlusOriginalChatEngine."
            )
    ...
    def chat(
        ...
        # Query with standalone question for retrieval and original message for a response
        query_response = self._query_engine.multi_query(condensed_question, message)
